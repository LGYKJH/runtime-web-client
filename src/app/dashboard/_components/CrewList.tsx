...
const CrewList = () => {
  ...
  return (
    <div className="w-full flex flex-col justify-start items-center gap-y-7 pl-10 pr-7 py-7 flex-1 h-full">
      ...
      <div className="w-full h-full flex-1 overflow-y-auto flex flex-col justify-start items-center gap-y-7 scrollbar-thin scrollbar-thumb-secondary scrollbar-thumb-rounded-full scrollbar-track-muted scrollbar-track-rounded-full">
        {Array(20)
          .fill(0)
          .map((_, index) => (
            <CrewCard key={index} />
